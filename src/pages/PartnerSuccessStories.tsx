...
const PartnerSuccessStories = () => {
  ...
  return <div className="min-h-screen bg-gray-50">
      <PageHeader title="Partner Success Stories" subtitle="Real-world success from our valued partners" />
      ...
      <div className="p-6 bg-[#f9f9f9]">
        <div className="max-w-[1200px] mx-auto my-8 px-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[15px] md:gap-[20px]">
            {caseStudies.map((study, index) => <div key={index} className="bg-white rounded-lg shadow-[0px_5px_10px_rgba(0,0,0,0.2)] p-6 
                          transition-all duration-300 hover:shadow-[0px_10px_15px_rgba(0,0,0,0.3)]
                          hover:translate-z-[10px] cursor-pointer" style={{
            transformStyle: 'preserve-3d'
          }}>
                <h3 className="flex items-center mb-4 font-poppins font-bold text-left text-sm">
